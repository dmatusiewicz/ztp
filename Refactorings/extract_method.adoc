...
```ruby
#
# [START] Refactoring wrapper
#

# Create Orders class
class Orders
  # Daclare :amount field
...
# In order to show some output - set amount values for those objects
@orders.each do |order|
  order.amount = 1
end

# Set another missing value in print_owing
@name = 'Syntetic_Name'

# Call function that we are about to refactor.
print_owing
```
