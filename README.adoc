...
Innymi słowami, refactoring to taki proces poprawiania kodu
w trakcie którego nie jest zmieniane jego działanie ale
jest udoskonalana jego wewnętrzna struktura. 
