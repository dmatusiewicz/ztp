...
So we should organize code to allow for easy changes.
...
The classes you create will affect how you think about your
application *forever*.

Q: How to create classes to allow for easy changes?
